 ...
 * class is created. It is suggested to run the GenerateTrajectory class at least
 * 30 seconds before this is run to ensure the trajectory is generated and saved.
 * Trajectories are persistent across reboots.
 */
public class DriveUsingTrajectory extends Command {
	...
	/**
	 * Create a new DriveUsingTrajectory command.
	 * This command will follow a trajectory of a given name.
     ...
     * Sets the drivetrain output based on EncoderFollowers and heading error.
     */
    protected void execute() {
    	double outputL = left.calculate(RobotIO.leftEncoder.getRaw() / 4);
		double outputR = right.calculate(RobotIO.rightEncoder.getRaw() / 4);
