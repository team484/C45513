...
/**
* Vision pipeline for detecting cubes in the camera frame. The result of this
* pipeline is recorded in filterContoursOutput.
*/
public class CubeVisionPipeline implements VisionPipeline {
	...
	//Constants
	private static final double[] hsvThresholdHue = {17.0, 47.0};
	private static final double[] hsvThresholdSaturation = {96.0, 244.0};
	private static final double[] hsvThresholdValue = {25.0, 255.0};
